...
Real integration with Bybit API using CCXT
"""
...
class BybitAdapter(BaseExchangeAdapter):
    """Bybit exchange adapter with full trading capabilities"""
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            raise ExchangeError(f"Bybit connection failed: {str(e)}")
    ...
    async def create_order(
        ...
        try:
            ...
            self.logger.info(f"Order created on Bybit: {order['id']}")
